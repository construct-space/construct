...
export const FRONTEND_OPTIONS: Record<string, TechStack[]> = {
  web: [
    ...
    },
    {
      ...
      description: 'Progressive Vue framework with fast Vite bundler and excellent tooling',
      pros: ['Gentle learning curve', 'Great docs', 'Composition API', 'Fast HMR'],
      cons: ['Smaller ecosystem than React', 'No built-in SSR without plugins'],
      bestFor: ['SPAs', 'Dashboards', 'Rapid prototyping', 'Small-medium projects']
    },
    {
      value: 'nextjs',
      label: 'Next.js',
