...
<template>
  <div
    class="group card relative text-left p-4 rounded-xl border transition-all duration-200 cursor-pointer border-[var(--app-border)] hover:border-[var(--app-accent)]/40 bg-[var(--app-surface)] hover:bg-[var(--app-muted)]/5"
