...
import * as tauriFsModule from '@tauri-apps/plugin-fs'
import { invoke as tauriInvokeStatic } from '@tauri-apps/api/core'
...
// Tauri APIs — statically imported (externalized to host globals by build)
const tauriFs = tauriFsModule
const tauriInvoke = tauriInvokeStatic

const initTauri = async () => {
  // No-op: Tauri APIs are statically imported
  return true
}
